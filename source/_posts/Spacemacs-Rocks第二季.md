...
[https://travis-ci.org/emacs-china/Spacemacs-rocks.svg?branch=master](https://travis-ci.org/emacs-china/Spacemacs-rocks)
...
更多有关 Org-capture 的内容可以在[这里](http://orgmode.org/manual/Capture.html)找到。
...
[Writing the Simplest Emacs company-mode Backend](http://sixty-north.com/blog/writing-the-simplest-emacs-company-mode-backend)
...
-   [百度网盘](http://pan.baidu.com/s/1eRTHBLC)
-   [优酷](http://v.youku.com/v_show/id_XMTYxMzYyNjc4MA==.html)
-   [Youtube](https://youtu.be/etLqMM5nmqI)

从今天的内容开始介绍 Spacemacs. 地址: [Spacemacs](https://github.com/syl20bnr/spacemacs)
...
如果你需要使用 [emacs-china](http://elpa.emacs-china.org/) 的配置源, 此时可以终止 emacs, 然后在~/.spacemacs 中的 dotspacemacs/user-init 函数中加入以下代码:
...
-   [百度网盘](http://pan.baidu.com/s/1mi1vZTI)
-   [优酷](http://v.youku.com/v_show/id_XMTYyODgxNjU0OA==.html)
-   [YouTube](https://youtu.be/qQqpWWjub6A)
...
-   [百度网盘](http://pan.baidu.com/s/1kVroHCj)
-   [优酷](http://v.youku.com/v_show/id_XMTYyOTcyNjk0NA==.html)
-   [Youtube](https://youtu.be/RMofkN3IcKE)
...
在之前的版本中, 这个函数的返回值是 3, 在0.8版本中被修改为了一个列表. 如果要修复这个问题, 我们需要在使用返回值的时候加上 cdr, 具体的修改可以查看[fix break API changes for ivy 0.8](https://github.com/syl20bnr/spacemacs/pull/6478).
...
-   [百度网盘](http://pan.baidu.com/s/1slMRuot)
-   [优酷](http://v.youku.com/v_show/id_XMTY0NjUwMTM5Mg==.html)
-   [Youtube](https://youtu.be/85g3defJP6M)
...
从今天的视频开始, 将使用 [子龙山人的配置](https://github.com/zilongshanren/spacemacs-private) 来讲解视频. 这份配置对 spacemacs 的定制有两个不同点:
...
在第四天的内容中已经讲解过 Dired Mode 的操作, 具体可以查看 [Dired Mode](https://book.emacs-china.org/#orgheadline22).
...
-   [百度网盘](http://pan.baidu.com/s/1miMvDji)
-   [优酷](http://v.youku.com/v_show/id_XMTY0NzUxOTI2NA==.html)
-   [Youtube](https://www.youtube.com/watch?v=vt7FQO9HpBU&list=PL-61yFRAEMlXDnsm3VHfrAm4oT6vVylRG&index=8)
...
对 Spacemacs 中的快捷键操作就介绍到这里, 更多的快捷键介绍可以到 [Spacemacs ABC](https://www.youtube.com/playlist?list=PLrJ2YN5y27KLhd3yNs2dR8_inqtEiEweE) 去查看.
...
-   [百度网盘](http://pan.baidu.com/s/1hr4CYBq)
-   [优酷](http://v.youku.com/v_show/id_XMTY1Njc1MjUxNg==.html)
-   [Youtube](https://www.youtube.com/watch?v=afWk8DBOY68)
